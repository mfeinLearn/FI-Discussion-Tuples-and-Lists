...
### Prompt 4: Provide a code block answer and brief explanation of the code choices used to answer the initial discussion prompt. Also, include code snippets or examples if possible to illustrate your points.
